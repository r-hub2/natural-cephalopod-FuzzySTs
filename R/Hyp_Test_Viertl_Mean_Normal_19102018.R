...
p.value.mean.normal <- function(data.fuzzified, type, H0, H1, s.d, sig, dist.type, i=1, j=1, theta= 1/3, thetas = 1, p=2, q=0.5, breakpoints=100)  {
    ...
    {
      p_L = pnorm( t.U ,  H0.L  , s.d/(n^0.5))
      p_U = pnorm( sort(t.L, decreasing = TRUE),  sort(H0.U), s.d/(n^0.5))
    ...
    {
      p_L = 1-pnorm( t.U ,  H0.L  , s.d/(n^0.5))
      p_U = 1-pnorm( sort(t.L, decreasing = TRUE) ,  sort(H0.U) , s.d/(n^0.5))
    ...
    {
      p_L = 2*(1-pnorm( t.U ,  H0.L  , s.d/(n^0.5)))
      p_U = 2*(1-pnorm( sort(t.L, decreasing = TRUE) ,  sort(H0.U)  , s.d/(n^0.5)))
    ...
    {
      p_L = 2* pnorm( t.U ,  H0.L  , s.d/(n^0.5))
      p_U = 2* pnorm( sort(t.L, decreasing = TRUE) ,  sort(H0.U)  , s.d/(n^0.5))
